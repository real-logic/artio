...
public class ILink3OffsetCalculatorTest
{
    @Test
    public void shouldLoadSeqNumOffset()
    {
        assertEquals(NewOrderSingle514Decoder.seqNumEncodingOffset(),
            ILink3OffsetCalculator.seqNumOffset(NewOrderSingle514Decoder.TEMPLATE_ID));
    }

    @Test
    public void shouldSupportMissingSeqNumOffset()
    {
        assertEquals(ILink3OffsetCalculator.MISSING_OFFSET,
            ILink3OffsetCalculator.seqNumOffset(NotApplied513Decoder.TEMPLATE_ID));
    }
    ...
    public void shouldLoadPossRetransOffset()
    {
        assertEquals(PartyDetailsDefinitionRequestAck519Decoder.possRetransFlagEncodingOffset(),
            ILink3OffsetCalculator.possRetransOffset(PartyDetailsDefinitionRequestAck519Decoder.TEMPLATE_ID));
    }
    ...
    {
        assertEquals(ILink3OffsetCalculator.MISSING_OFFSET,
            ILink3OffsetCalculator.possRetransOffset(NewOrderSingle514Decoder.TEMPLATE_ID));
    }
}
